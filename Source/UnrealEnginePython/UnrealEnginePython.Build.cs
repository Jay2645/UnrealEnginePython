...
public class UnrealEnginePython : ModuleRules
{
...
#endif
	{
		...
		PublicIncludePaths.AddRange(
			new string[] {
				Path.Combine(ModuleDirectory, "Public").ToString(),
		...
		PrivateIncludePaths.AddRange(
			new string[] {
				Path.Combine(ModuleDirectory, "Private").ToString(),
		...
		if ((Target.Platform == UnrealTargetPlatform.Win64) || (Target.Platform == UnrealTargetPlatform.Win32))
		{
			if (pythonHome == "")
			{
				...
				{
					pythonHome = DiscoverPythonPath(windowsKnownPaths, "Win32");
				}
		...
		else if (Target.Platform == UnrealTargetPlatform.Linux)
		{
			if (pythonHome == "")
			{
				...
				System.Console.WriteLine("Using Python libraries: " + libsPath);
